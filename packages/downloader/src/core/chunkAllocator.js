...
class ChunkAllocator {
     ...
     */
    createInitialSegments(resumable) {
     ...
     */
    splitLargestSegment(segments, nextId) {
    ...
    static detectProtocol(url) {
        try {
            ...
            if (['http', 'https', 'ftp', 'magnet'].includes(proto))
                return proto;
        }
        catch { }
        return 'http';
